...
- 2x [RTL-SDR](https://www.rtl-sdr.com/) with clock synchronisation (capture type `dual-rtl`, includes optional USB offset calibration; `gain[0]`/`serial[0]` map to the reference channel, `gain[1]`/`serial[1]` to surveillance).
